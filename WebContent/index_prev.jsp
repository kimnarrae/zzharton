			...
			<div id="main-contents">
				<div style="height:240px; text-align:center;">
					<div style="width:30%; float:left; height:100%;">
						<img class="main-img" src="/zzharton/page/image/common/img-chart-main.png" style="width:200px;height:200px;margin-top:50px;">
					</div>
					<div style="width:65%; float:left; height:80%;text-align:left;margin-top:43px;padding-right:20px;">
